        ...
        success: function (data) {
            ...
            if (blockCount !== 0) {
                for (let i = 0; i < blockCount; i++) {
                    const teaser_block = fourthDesignParseObjectToHTML(array_with_teasers_objects[i]);
                    setTimeout(function() {
                        let col_def = findMinNewsInCol();
                        let window_width = $(window).width();
                        switch(col_def) {
                            case 1:
                                $('.first_col').append(teaser_block);
                                break;
                            case 2:
                                if (window_width >= 576) {
                                    $('.second_col').append(teaser_block);
                                } else {
                                    $('.first_col').append(teaser_block);
                                }
                                break;
                            ...
                            case 4:
                                if (window_width >= 992) {
                                    $('.fourth_col').append(teaser_block);
...
function fourthDesignParseObjectToHTML(item) {
    ...
    return `<div class="grid-item item item-product">
                    <a class="teaser teaser-product" href="${href}" target="_blank" style="background: rgb(198, 140, 144);">
                        <div class="teaser-image">
                            <div class="background" style="background: linear-gradient(0deg, rgb(198, 140, 144) 0px, transparent 100%);"></div>
                            <img class="img-fluid" src="${src}" alt="">
                            <div class="category" style="color: #212121; background: rgb(198, 140, 144);">
                                Лучшее
                            </div>
                        </div>
