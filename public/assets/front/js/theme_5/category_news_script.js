...
const list_for_xs_categories = [0, 1, 2, 3, 5, 6, 7, 8];
const list_for_m_categories = [4, 9, 10, 11];
...
function getNewBlockSize(num_blocks) {
    ...
    if (list_for_xs_categories.includes(remainder)) {
        return '-size-xs'
    } else if (list_for_m_categories.includes(remainder)) {
        return '-size-m'
    }
    return void 0;
}