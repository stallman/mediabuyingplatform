...
class Theme_1_Extension extends AppExtension
{
    public function getFunctions()
    {
        return [
            new TwigFunction('render_nav_bar', [$this, 'renderNavBar']),
    ...
    public function renderNavBar()
    {
        ...
        return $this->twigEnvironment->render('front/theme_1/partials/nav_bar.html.twig', [
